...
inputvolt_length=30000; % 20 cycles (0.4 sec)
global time_stamp;
...
global freqtable;
freqtable = maxfreq:-dfreq:minfreq;% keep descending order

global Vmax;
Vmax=300;% Input Voltage Magnitude
Vschmitt=175;        % Calibration for schmitt trigger for freq
kVschmitt=Vschmitt^2;% Calibration for schmitt trigger for kfreq
cycles=4;            % number of cycles for which avg is to be done
...
% plot of Schmitt comparing voltages
